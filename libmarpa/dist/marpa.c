...
#define AIM_Count_of_R(r) AIM_Count_of_G(G_of_R(r) ) 
...
#define NO_OF_PSARS 1
#define Size_of_PSL(r) (sizeof(PSL_Object) +(AIM_Count_of_R(r) -1) *sizeof(PSIM_Object) ) 
