...
The L<C<Marpa::XS::Recognizer::tokens>|/tokens>
...
The
L<Marpa::XS::Recognizer> handles both recognition and evaluation.
...
For details about terminal symbols, see L<Marpa::XS::Grammar/"Terminals">.
...
models|Marpa::XS::Advanced::Models>.
...
on
semantics|Marpa::XS::Semantics/"Ranking">.
