...
Marpa::XS - Future XS extension of Marpa
...
=head1 PLEASE DO NOT USE THIS MODULE

PLEASE DO NOT USE THIS MODULE.
As of now THIS MODULE CONTAINS NOTHING USEFUL.
When complete, it will be the XS extension for
L<the Marpa
parser|Marpa>.

Marpa::XS resides on CPAN
so that the cpantesters can give me feedback
on the very early development versions.
This will help ensure that
the final version of Marpa::XS
is as bug-free on
as wide a variety of platforms
as possible.
Especially with C code,
it's easier and safer to make it portable
right from the start,
rather than to let portability be an afterthought.
...
Grammars are L<Marpa::XS::Grammar> objects.
...
Marpa grammars are L<Marpa::XS::Grammar> objects.
They are created
with the
L<Marpa::XS::Grammar::new|Marpa::XS::Grammar/"new">
constructor.
The arguments to 
L<Marpa::XS::Grammar::new|Marpa::XS::Grammar/"new">
are references to
...
=head2 Marpa::XS::Grammar::precompute
...
C<Marpa::XS::Recognizer::new> creates a new recognizer.
...
=head2 Marpa::XS::Recognizer::tokens
...
C<Marpa::XS::Recognizer::tokens> reads the input to be recognized.
...
=head2 Marpa::XS::Recognizer::value
...
The C<Marpa::XS::Recognizer::value> method returns
a reference to the parse result's value,
if there was a parse result.
If there was no parse result,
C<Marpa::XS::Recognizer::value>
returns
C<undef>.

=head2 Resolving the Semantics

The first thing C<Marpa::XS::Recognizer::value> needs to do is
...
the C<Marpa::XS::Recognizer::value> method iterates through the parse results.
For each call,
...
C<Marpa::XS::Recognizer::value> returns C<undef>.
If there were no parse results,
C<Marpa::XS::Recognizer::value> returns C<undef> the first
...
see the
L<Marpa::XS::Grammar> document.
For full details on Marpa's recognizer objects and their methods,
see the
L<Marpa::XS::Recognizer> document.

L<Marpa::XS::Parse_Terms> is intended as a quick refresher in
parsing terminology.
Marpa's standard semantics are fully described in the
L<Marpa::XS::Semantics> document.
Techniques for tracing and for debugging your Marpa grammars
are described in the
L<Marpa::XS::Tracing> document and the
L<Marpa::XS::Debug> document.

=head2 Advanced Documents

The L<Marpa::XS::Advanced::Implementation> describes Marpa's internals.
The L<Marpa::XS::Advanced::Models> document (yet to be written)
...
L<Marpa::XS::Advanced::Bibliography>.
L<Marpa::XS::Advanced::Algorithm> describes the Marpa algorithm itself.
...
L<Leo 1991|Marpa::XS::Advanced::Bibliography/"Leo 1991">.
Aycock, Horspool, and Leo, in turn, based their
algorithms on the
L<algorithm discovered by Jay Earley|Marpa::XS::Advanced::Bibliography/"Earley 1970">.
...
L<another
document|Marpa::XS::Advanced::Algorithm>.
...
Marpa::XS is free software under the GNU General Public License, Version 2.
For details see the LICENSE file in the Marpa::XS distribution.
