...
This B<factoring> is exponential in the theoretical worst case,
...
This Earley item is for AHFA state 4 (that is the "C<S4>" part).
...
L<Grune and Jacobs|Marpa::XS::Advanced::Bibliography/"Grune and Jacobs 2008">.
...
Here's what C<show_AHFA> says about AHFA state 5:
...
of AHFA state 5 begins with its name: C<S5>.
...
based on the ideas in L<Aycock and Horspool 2002|Marpa::XS::Advanced::Bibliography/"Aycock and Horspool 2002">.
...
the Earley item S5@0-3.
S5@0-3 is the Earley item we
already looked at.
...
see L<Marpa::XS::Advanced::Models>.
...
In the first line of the C<show_AHFA> output for AHFA state S9,
...
|Marpa::XS::Advanced::Bibliography/"Aycock and Horspool 2002">
...
The transition for C<Factor> in AHFA state S6
...
Earley item S10@0-3 has AHFA state S10.
...
The Leo logic is dealt in L<another
document|Marpa::XS::Advanced::Leo>.)
...
Marpa then evaluates the pre-order tree bottom-up,
...
Marpa uses the ideas from L<an algorithm developed
by Joop Leo|Marpa::XS::Advanced::Bibliography/"Leo 1991"> to deal
with right recursion.
The Leo logic is complex enough to merit its own
example, and so is presented in L<a separate
document|Marpa::XS::Advanced::Leo>.
